const todayData = {
  ...
  pitcherTargets: [
    { pitcher: "JP Sears", stats: "LHP • High HR risk • HR/9 • FB% • Hard-Hit% allowed", grade: "🔥🔥🔥🔥🔥" }
  ],

  moneyline: [
    { team: "Braves", reason: "POPS edge: offense + home field + matchup lean", confidence: "TBD%" }
  ],

  weather: [
    { stadium: "Game Weather", condition: "Wind 8 mph out • Rain 0%", boost: "Weather Score TBD/10" }
  ],

  nrfi: [
    { game: "Mets vs Braves", pick: "YRFI lean", confidence: "TBD%", reason: "Lineup strength + game environment" }
  ]
};
