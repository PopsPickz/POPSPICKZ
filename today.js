  ...
  pitcherTargets: [
    {
      ...
      flyBall: "Elevated",
      grade: "🔥🔥🔥🔥🔥",
      verdict: "Primary pitcher to attack. Dodgers bats have the strongest run support edge."
    },
    {
    ...
    },
    {
      ...
      grade: "🔥🔥🔥🔥",
      verdict: "Yankees bats are live if lineup is healthy."
    },
    {
  ...
  games: [
    {
      ...
      moneylinePickDetail: {
        ...
        confidence: "87/100",
        reason: "Phillies have the stronger pitcher, bullpen, offense, and run-support edge."
      },
      nrfiPick: {
        pick: "NRFI",
        confidence: "76%",
...

    {
      ...
      pitchers: {
        ...
        home: {
          ...
          flyBall: "Fly-ball lean",
          targetRating: "🔥🔥🔥🔥",
          verdict: "Yankees bats are live if healthy."
        }
      },
      hrTargets: [],
      hitTargets: [],
      moneylinePickDetail: {
        ...
        confidence: "72/100",
        reason: "Yankees hold a slight run-support and offensive edge, but this is not a premium moneyline."
      },
      nrfiPick: {
        pick: "NRFI",
        confidence: "73%",
    ...
    },
    {
      ...
      moneylinePickDetail: {
        ...
        confidence: "70/100",
        reason: "Nationals have small home-field and run-support edge."
      },
      nrfiPick: {
        pick: "YRFI",
        confidence: "68%",
...

    {
      ...
      moneylinePickDetail: {
        pick: "Atlanta Braves",
        confidence: "93/100",
        reason: "Braves have the stronger offense, run support, bullpen, defense, and home field."
      },
      nrfiPick: {
        pick: "YRFI",
        confidence: "65%",
...

    {
      ...
      moneylinePickDetail: {
        ...
        confidence: "82/100",
        reason: "Brewers have better run support, bullpen, offense, and defense."
      },
      nrfiPick: {
        pick: "NRFI",
        confidence: "69%",
...

    {
      ...
      moneylinePickDetail: {
        ...
        confidence: "68/100",
        reason: "Small run-support edge, but not a premium moneyline play."
      },
      nrfiPick: {
        pick: "NRFI",
        confidence: "71%",
...

    {
      ...
      moneylinePickDetail: {
        ...
        confidence: "81/100",
        reason: "Blue Jays have the stronger pitcher, offense, and slight run-support edge."
      },
      nrfiPick: {
        pick: "NRFI",
        confidence: "78%",
...

    {
      ...
      moneylinePickDetail: {
        ...
        confidence: "96/100",
        reason: "Dodgers have the biggest run-support edge on the slate plus bullpen, offense, defense, and home-field advantage."
      },
      nrfiPick: {
        pick: "YRFI",
        confidence: "82%",
